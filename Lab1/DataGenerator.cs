...
namespace Lab1
{
    public static class DataGenerator
    {
        ...
        public static List<Journal> GenerateJournals()
        {
            ...
            {
                new Journal("Ca-A Cancer Journal for Clinicians", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                new Journal("Nature Reviews Molecular Cell Biology", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                new Journal("Quarterly Journal of Economics", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                new Journal("Cell", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                new Journal("MMWR Recommendations and Reports", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                new Journal("New England Journal of Medicine", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                ...
                new Journal("Nature Reviews Materials", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
                new Journal("International Conference on Computer Vision Proceedings", random.Next(4, 14),
                    new DateOnly(random.Next(2000, 2015), random.Next(1, 12), random.Next(1, 25)),
                    random.Next(5, 100) * 100),
